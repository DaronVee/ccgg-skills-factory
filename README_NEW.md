...
# Step 1: Download the latest Release ZIP from:
#   https://github.com/DaronVee/ccgg-skills-factory/releases
...
# Say: "Create a new skill for [your use case]"
```

**Using Git instead?**  then run install command
# Step 1: Download the latest Release ZIP from:
#   https://github.com/DaronVee/ccgg-skills-factory/releases
# Step 2: Extract and install
cd ccgg-skills-factory
